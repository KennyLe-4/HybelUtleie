<?php
// Denne klassen henter alle nylige lagt til annonser fra databasen, og laster det opp i en tabell.
class nyligeAnnonser
{
    public function hentNyligeAnnonser()
    {

        global $pdo;
        $q = $pdo->prepare("SELECT * FROM `annonser` ORDER BY `annonseID` DESC");
