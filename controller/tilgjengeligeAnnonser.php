<?php
// Denne klassen henter alle tilgjengelige annonser som ikke er utleid. 
class TilgjengeligeAnnonser
{
    public function HentTilgjengeligeAnnonser()
    {

        global $pdo;
        $q = $pdo->prepare("SELECT * FROM `annonser` WHERE status= 1");
